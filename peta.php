...
?>
[<?php echo $item->id_hewan ?>,'<?php echo $item->nama_hewan ?>','<?php echo $item->alamat ?>', <?php echo $item->longitude ?>, <?php echo $item->latitude ?>],
<?php 
}
} 
?>    
...
function setMarkers(map, locations)
{
    ...
    for (var i = 0; i < locations.length; i++) {
        ...
        var singa = new google.maps.Marker({
            position: myLatLng,
            map: map,
            title: office[1],
            icon:'img/mark.png'
        ...
        google.maps.event.addListener(singa, 'click', getInfoCallback(map, contentString));
    }
}
